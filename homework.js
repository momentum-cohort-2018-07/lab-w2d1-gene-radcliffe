...
function howOld(birthdate, date){
    ...
    var convertToYear = difference / 31104000000; // 31104000000 is the number of milliseconds in a year
    var returnVal;
     
    
    var truncate = Math.floor(convertToYear);   
    returnVal = truncate ; //default return for newborns

    //check if it is before your birthday
    var date1 = date.getMonth() + date.getDay()
    var date2 = birthdate.getMonth() + birthdate.getDay()
    if(date1 < date2){
        return returnVal -1;
